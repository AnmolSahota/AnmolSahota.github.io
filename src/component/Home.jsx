...
import svg from "../screenshot/about.svg";
...
function Home() {
  ...
  if (title == false) {
    document.title = "Anmol Sahota | Portfolio";
  } else {
      ...
      >
        ...
        >
          <Box id="user-detail-name" fontSize={"35px"}>
            ...
            <Text display={"inline-block"} mb={"10px"} fontWeight={700}>
              <Type />
            </Text>
          </Box>
          <Box>
            <Text mb={"10px"} color={"#628087"}>
              Self-motivated aspiring Full-stack web developer. A quick learner
              who is passionate about developing web applications. I am
              proficient in React, Redux Express, MongoDB, NodeJS, HTML, CSS and
              JavaScript.
            </Text>
            <Text>
              <a
                ...
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/10r2JrtcvtW_J6gZC3uUvZz0styz8JCIk/view"
                  )
                }
              >
                <Button
        ...
        <GridItem>
          <Img src={svg} alt="React Logo" height={"100%"} width={"100%"} />
        </GridItem>
      </Grid>
    </Box>
  );
