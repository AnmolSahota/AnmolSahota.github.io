...
import { call, github } from "../images";
import mail from "../screenshot/gmail.png"
...
function Contact() {
  ...
  // const bg2 = useColorModeValue("#2d3748", "#ffffff");
  const bg2 = useColorModeValue("#ffffff", "#2d3748");
  const confetti = {
    light: {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await axios.post(
        "https://nodemailer-beryl-theta.vercel.app/api/send-email",
        {
          name: name,
          email: email,
          message: message,
  ...
  return (
    ...
    >
      ...
      >
        <GridItem pt={"40px"}>
          <Text fontSize={"16px"} mb={"20px"} mt={"-25px"} color={"#718079"}>
          ...
          <Text id="contact-github" className={styles.contactfirst}>
            <a target="_blank" href="https://github.com/AnmolSahota">
              <Text display={"inline-block"} w={"27px"} h={"27px"}>
                <Img
                  src={github}
                  borderRadius={"50%"}
                  display={"inline"}
              ...
              <Text className={styles.contactpad}>Github</Text>
            </a>
          </Text>
          <Text id="contact-linkedin" className={styles.contactfirst}>
            <a
              href="https://www.linkedin.com/in/anmol-sahota-438456250/"
              target={"_blank"}
            >
              <FontAwesomeIcon
                icon={faLinkedin}
                ...
                borderRadius={"50%"}
              />
              <Text className={styles.contactpad}>linkedin</Text>
            </a>
          </Text>
          <Text
            id="contact-phone"
            display={"inline"}
            className={styles.contactfirst}
          >
            <Text display={"inline-block"} w={"27px"} h={"27px"}>
              <Img
                src={call}
            ...
            <Text className={styles.contactpad}>+91-8097229928</Text>
          </Text>
          <Text id="contact-email" className={styles.contactfirst}>
            <Text display={"inline-block"} w={"27px"} h={"27px"}>
              <Img
                src={mail}
                display={"inline"}
            ...
            <Text className={styles.contactpad}>
              anmolsahota05760@gmail.com
            </Text>
          </Text>
        </GridItem>
        <GridItem
        ...
        >
          {/* <Mail /> */}
          <Box className={styles.form} w={{ sm: "90%", md: "60%" }} bg={bg2}>
            <form onSubmit={handleSubmit}>
              <label>
                Name
                <Text display={"inline-block"} color={"#f56565"}>
                  *
                </Text>
              </label>
              <Input
              ...
              <Button
                ...
                sx={{ width: "100%" }}
              >
                {loader ? <Loader /> : "Lets connect"}
              </Button>
            </form>
          </Box>
        </GridItem>
      </Grid>
      <Text textAlign={"center"} fontWeight={700} pt={"35px"} pb={"20px"}>
        <Text display={"inline-block"} mr={"15px"}>
          Designed & Built by
        </Text>
        <FontAwesomeIcon icon={faHeart} fontSize={"16px"} color="#0a66c2" />
        <Text display={"inline-block"} ml={"15px"}>
          Anmol Sahota
        </Text>
      </Text>
    </Box>
