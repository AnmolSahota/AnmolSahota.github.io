...
import redux from "../screenshot/redux.png";
import Skill from "../screenshot/Skill.jpg";
...
function Skills() {
  ...
  return (
    <Box
      ...
      p={{ base: "0px 10px", md: "0px 70px", sm: "0px 50px" }}
      bg={bg}
      css={{
      ...
      >
        <GridItem>
          <Text
            ...
            fontWeight={700}
            mb={"10px"}
            pl={{ base: "auto", md: "60px" }}
          >
            I Persist the Following Skills
          </Text>
          <Text mb={"15px"} color={"#718079"} pl={{ base: "auto", md: "60px" }}>
              ...
              >
                ...
                >
                  <GridItem
                    ...
                    borderBottom={"1px solid #718079"}
                  >
                    <span className="skills-card">
                      <Box className={styles.imgskill} display={"inline-block"}>
                        <Img
                          height={"100%"}
                          width={"100%"}
                          src={html}
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">HTML 5</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">CSS 3</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">JavaScript</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">React js</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">Redux</span>
                      </Text>
                    </span>
                  </GridItem>
                </Grid>
              </GridItem>
              <GridItem className={styles.skillitem}>
                <Grid gap={3}>
                  <GridItem
                    className={styles.bug}
                    width={{ base: "85%", md: "135px" }}
                  >
                    <span className="skills-card">
                      <Box className={styles.imgskill} display={"inline-block"}>
                        <Img
                      ...
                      <Text display={"inline-block"} className={styles.box}>
                        <span className="skills-card-name">Node js</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">Express js</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">Mongo Db</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline-block"} className={styles.box}>
                        <span className="skills-card-name">Github</span>
                      </Text>
                    </span>
                  </GridItem>
                  <GridItem
                  ...
                  >
                    <span className="skills-card">
                      ...
                      <Text display={"inline"} className={styles.box}>
                        <span className="skills-card-name">Postman</span>
                      </Text>
                    </span>
                  </GridItem>
                </Grid>
