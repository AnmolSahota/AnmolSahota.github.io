...
import Mine from "../screenshot/Mine.jpg";
...
function About() {
  ...
  return (
    <Box
      ...
      pb={"30px"}
      height={{ sm: "auto", lg: "90vh" }} // after add something give height 90vh
      ...
      >
        ...
        >
          <Text fontSize={"35px"} fontWeight={700}>
            I'm Anmol Sahota from
          </Text>
          <Text fontSize={"30px"} fontWeight={700}>
            Mumbai, Maharashtra
          </Text>
          <Text m={"10px 0px"} fontSize={"25px"}>
            Full-stack web developer
          </Text>
          <Text mt={"10px"} color={"#628087"} id="user-detail-intro">
            Passionate Full-Stack Web Developer with strong Design and
            Problem-Solving skills. A highly disciplined and motivated person
            having proficiency in a wide range of front-end and back-end skills
            like React, Redux, Node, Javascript, ExpressJS, MongoDB, etc.
            Looking forward to launching a career as a Full Stack developer
          </Text>
          <Box mt={"40px"}>
            <Box display={"inline"} marginRight="20px">
              <a href="https://github.com/AnmolSahota" target={"_blank"}>
